...
export class SBSNumeric extends Component<NumericProps,State> implements IDataAPIDesign{
  plus(): void {
    this.setState((state)=> ({
      value:state.value +1
    }))
  ...
  render() {
    return <div className="grid-container--sbs" style={{backgroundColor: this.props.color ?  this.props.color: '#FFFFFF'}}>
